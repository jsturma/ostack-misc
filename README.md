...
![Backup flow sequence diagram](docs/diagram.svg)

Source files for editing:

- **[docs/diagram.mmd](docs/diagram.mmd)** — Mermaid sequence diagram (render with [Mermaid Live](https://mermaid.live) or any Mermaid-compatible viewer)
- **[docs/diagram.drawio](docs/diagram.drawio)** — Draw.io diagram (edit with [draw.io](https://app.diagrams.net/) or VS Code Draw.io extension)
- **docs/diagram.svg** — Rendered SVG (generated from the diagram; use the .mmd or .drawio to make changes)
