...
- **[go/](go/)** — Go port of the same backup tool using [Gophercloud v2](https://github.com/gophercloud/gophercloud); backups run in parallel (VMs and volumes). Build: `go build -o protect-ostack .` in `go/`. See [go/README.md](go/README.md).
